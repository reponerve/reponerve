...
| **MCP** | `.cursor/mcp.json` → `reponerve mcp` | When connected — 49 tools (`ask`, `explain`, `doctor`, `reuse_check`, `ship_check`, …) |
...
`v1.0.0` shipped 2026-06-18. Latest tag: `v1.5.1`. Post-v1.0 work is RFC-gated (`docs/roadmap/v1.x-backlog.md`).
